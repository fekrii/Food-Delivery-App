...
class ResturantProfile(models.Model):
    user = models.OneToOneField(CustomUser, related_name="resturant_profile", on_delete=models.CASCADE)
...
class DriverProfile(models.Model):
    user = models.OneToOneField(CustomUser, related_name="driver_profile", on_delete=models.CASCADE)
    name= models.CharField(max_length=255, blank=True, null=True)
